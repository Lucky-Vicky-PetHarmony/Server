...
public class OpenAiServiceImplTest {
    ...
    // OpenAiServiceImpl 클래스의 analyzeSpecialMark 메서드를 테스트하는 단위 테스트
    @Test
    public void testAnalyzeSpecialMark() {
        ...
        // 응답이 null이 아니고, 특정한 내용을 포함하는지 확인
        assertThat(response).isNotNull();
        assertThat(response).contains("unique"); // 예시로 unique라는 단어가 포함되는지 확인
    }
}
